...
export default function TransactionTable() {
  ...
  return (
    <Card className="overflow-hidden">
      <div className="space-y-3 border-b border-neutral-200 pb-6 dark:border-white/10">
      ...
      <div className="border-b border-neutral-200 py-3 text-xs text-neutral-500 dark:border-white/10 dark:text-neutral-400">
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-neutral-200 bg-neutral-50/90 dark:border-white/10 dark:bg-white/[0.03]">
              <th className="pl-0 pr-4 py-4 text-left text-[11px] font-semibold uppercase tracking-wider text-neutral-500 dark:text-neutral-400">
              ...
              <th className="pl-0 pr-4 py-4 text-left text-[11px] font-semibold uppercase tracking-wider text-neutral-500 dark:text-neutral-400">Description</th>
              <th className="pl-0 pr-4 py-4 text-left text-[11px] font-semibold uppercase tracking-wider text-neutral-500 dark:text-neutral-400">Category</th>
              <th className="pl-0 pr-4 py-4 text-left text-[11px] font-semibold uppercase tracking-wider text-neutral-500 dark:text-neutral-400">Type</th>
              <th className="pl-4 pr-0 py-4 text-right text-[11px] font-semibold uppercase tracking-wider text-neutral-500 dark:text-neutral-400">
            ...
            {filteredTransactions.length === 0 ? (
              ...
              filteredTransactions.map((txn) => {
                ...
                return (
                  ...
                  >
                    <td className="whitespace-nowrap pl-0 pr-4 py-4 font-mono text-sm tabular-nums text-neutral-600 dark:text-neutral-400">{formatDate(txn.date)}</td>
                    ...
                    <td className={`pl-4 pr-0 py-4 text-right font-mono text-sm font-semibold tabular-nums ${txn.type === 'income' ? 'text-neutral-900 dark:text-white' : 'text-neutral-500 dark:text-neutral-400'}`}>
                      {txn.type === 'income' ? '+' : '−'}
        ...
        {filteredTransactions.length === 0 ? (
          ...
          filteredTransactions.map((txn) => {
            ...
            return (
              <div
                key={txn.id}
                className="flex items-center gap-3 py-4 transition-colors duration-200 hover:bg-neutral-50 dark:hover:bg-white/[0.04]"
              >
